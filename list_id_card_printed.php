  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-12">
                      <h1 class="m-0">List of ID Card Printed:</h1>
 ...
 <div class="card">
     ...
     <div class="card-body">
         <table id="example1" class="table table-bordered table-striped">
             ...
             $q = "SELECT reg_number, first_name, others, course_of_study, `session` FROM `tblstudent` where `status` = 1 AND `course_of_study` = '$course_of_study' and session = '$session'  ORDER BY `reg_number`, `course_of_study`" ;
