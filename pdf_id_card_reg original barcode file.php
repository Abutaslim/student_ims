...
$mpdf =new  \Mpdf\Mpdf(['mode'=>'utf-8', 'format'=>[85.6, 56],'margin_left'=>0, 'margin_bottom'=>0, 'margin_top'=>0, 'margin_right'=>0]);
$mpdf->Cell(20,5,'',0,0, '');
	...
	while ($row = mysqli_fetch_array($result)) 
	{
		...
		if ($row['image_path'] != '') 
		{
				...
				if (file_exists('student_imgs/'.$row['image_path'].'')) 
				{
						...
						$qr = $invoice_no . '-qr.png';
						QRcode::png("Registration:- Student's Name: ".$fullname.";Phone:".$phone.";Invoice: ".$invoice_no.";Amount: ".$net_amount . ",Session: ". ACADEMIC_SESSION, $qr, 'H', 6, 6);
					...
					<table style= "font-size: 7px;  margin-top:0px; width: 100%; margin-left:5px;">
							...
							<tr >
								<td>Dean Student Affairs: <p> B/Group: '.$row['blood_group']. '</p><p>Guardian`s Phone: 08063253405</p> </td>
